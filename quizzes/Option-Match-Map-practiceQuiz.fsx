(**
// can't yet format YamlFrontmatter (["title: Option Match Map"; "category: Practice Quizzes"; "categoryindex: 1"; "index: 4"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown

[![Binder](../images/badge-binder.svg)](https://mybinder.org/v2/gh/nhirschey/teaching/gh-pages?filepath=quizzes/Option-Match-Map-practiceQuiz.ipynb)&emsp;
[![Script](../images/badge-script.svg)](/Teaching//quizzes/Option-Match-Map-practiceQuiz.fsx)&emsp;
[![Notebook](../images/badge-notebook.svg)](/Teaching//quizzes/Option-Match-Map-practiceQuiz.ipynb)
...
```
val it : TwoStocksPriceOb = { Time = 1
                              PriceA = Some 5
                              PriceB = None }
```
...
```
val it : TwoStocksPriceOb = { Time = 2
                              PriceA = Some 6
                              PriceB = Some 5 }
```
