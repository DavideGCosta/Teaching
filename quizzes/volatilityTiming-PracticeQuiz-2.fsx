(**
// can't yet format YamlFrontmatter (["title: Volatility Timing Part 2"; "category: Practice Quizzes"; "categoryindex: 1"; "index: 3"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown

[![Binder](../images/badge-binder.svg)](https://mybinder.org/v2/gh/nhirschey/teaching/gh-pages?filepath=quizzes/volatilityTiming-PracticeQuiz-2.ipynb)&emsp;
[![Script](../images/badge-script.svg)](/Teaching//quizzes/volatilityTiming-PracticeQuiz-2.fsx)&emsp;
[![Notebook](../images/badge-notebook.svg)](/Teaching//quizzes/volatilityTiming-PracticeQuiz-2.ipynb)
