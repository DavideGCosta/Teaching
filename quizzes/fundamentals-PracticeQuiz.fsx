(**
// can't yet format YamlFrontmatter (["title: Fundamentals"; "category: Practice Quizzes"; "categoryindex: 1"; "index: 1"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown

[![Binder](../images/badge-binder.svg)](https://mybinder.org/v2/gh/nhirschey/teaching/gh-pages?filepath=quizzes/fundamentals-PracticeQuiz.ipynb)&emsp;
[![Script](../images/badge-script.svg)](/Teaching//quizzes/fundamentals-PracticeQuiz.fsx)&emsp;
[![Notebook](../images/badge-notebook.svg)](/Teaching//quizzes/fundamentals-PracticeQuiz.ipynb)
