(**
// can't yet format YamlFrontmatter (["title: Volatility Timing Part 1"; "category: Practice Quizzes"; "categoryindex: 1"; "index: 2"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown
